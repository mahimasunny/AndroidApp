...
class LogDataAdapter constructor(context: Context, listener: LogDataItemClickedListener ) :
    ...
    inner class LogViewHolder(itemView: View, val clickListener: LogDataItemClickedListener) :
        ...
        val locationArea: TextView = itemView.findViewById(R.id.tvLocation);
        val typeArea: TextView = itemView.findViewById(R.id.tvType);
    }
    ...
    override fun onBindViewHolder(holder: LogViewHolder, position: Int) {
        ...
        holder.locationArea.text = current.location.toString();
        holder.typeArea.text = current.heartbeat.toString(); // current.audioFile.toString();
